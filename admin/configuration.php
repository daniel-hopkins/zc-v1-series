...
<body marginwidth="0" marginheight="0" topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0" bgcolor="#FFFFFF">
  ...
  <!-- body //-->
  <div class="row"><div class="large-12 column"><h4><?php echo $cfg_group->fields['configuration_group_title']; ?></h4></div></div>
  <div class="row">
    <div class="large-9 small-7 columns">
      <table border="0" width="100%" cellspacing="0" cellpadding="2">
        <tr class="dataTableHeadingRow">
          <td class="dataTableHeadingContent"><?php echo TABLE_HEADING_CONFIGURATION_TITLE; ?></td>
          <td class="dataTableHeadingContent show-for-small-up"><?php echo TABLE_HEADING_CONFIGURATION_VALUE; ?></td>
          <td class="dataTableHeadingContent show-for-large-up" align="right"><?php echo TABLE_HEADING_ACTION; ?>&nbsp;</td>
        </tr>
        <?php
